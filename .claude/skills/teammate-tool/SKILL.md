---
name: teammate-tool
description: Team coordination skill using TeamCreate to spawn and manage multi-agent teams. Use when the user wants agents to work together, coordinate, or collaborate on complex tasks. Spawns teams with shared task lists and teammate communication.
context: fork
---
...
## Available Sub-Agents for Teams
